...
Zen_RTS_BuildingType_East_HQ = ["Zen_RTS_F_East_HQConstructor", "Zen_RTS_F_East_HQDestructor", [], "HQ", "Cost: 5000, Time: 30, Picture: pictures\icon_remote.paa, Classname: Land_Research_HQ_F,"] call Zen_RTS_StrategicBuildingCreate;
...
Zen_RTS_Asset_Tech_East_Upgrade_TankFactory = ["Zen_RTS_F_East_Tech_Upgrade_TankFactory", "Upgrade Tank Factory", "Cost: 5000, Time: 60,", "Commander"] call Zen_RTS_StrategicAssetCreate;
Zen_RTS_Asset_Tech_East_Upgrade_Barracks = ["Zen_RTS_F_East_Tech_Upgrade_Barracks", "Upgrade Barracks", "Cost: 2000, Time: 35,", "Commander"] call Zen_RTS_StrategicAssetCreate;
