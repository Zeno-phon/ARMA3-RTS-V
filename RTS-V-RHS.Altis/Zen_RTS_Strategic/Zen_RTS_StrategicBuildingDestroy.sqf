...
// ZEN_FMW_MP_REAll("Zen_RTS_F_StrategicRemoveBuildingQueueClient", [_identifier], call)
...
ZEN_FMW_MP_REAll("Zen_RTS_F_StrategicRemoveBuildingDataLocal", [_identifier], call)
