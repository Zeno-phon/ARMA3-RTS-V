...
Zen_RTS_F_West_NavalConstructor = {
    ...
    BUILDING_VISUALS("Land_Lighthouse_small_F", -1, WestCommander, _dir, "Naval Factory", "b_art")
...
Zen_RTS_BuildingType_West_NavalFactory = ["Zen_RTS_F_West_NavalConstructor", "Zen_RTS_F_West_NavalDestructor", ["Zen_RTS_F_West_NavalUpgrade01"], "Naval Factory", "Cost: 2000, Time: 30, Picture: pictures\naval_ca.paa, Classname: Land_Lighthouse_small_F,"] call Zen_RTS_StrategicBuildingCreate;
...
Zen_RTS_Asset_West_GunBoat = ["Zen_RTS_F_West_AssetGunBoat","Armed Patrol Boat", "Cost: 500, Time: 10,"] call Zen_RTS_StrategicAssetCreate;
